...
// consisting of v and all its descendants in t. Determine whether or not there is
// a vertex v (possibly none) in tree t1 such that a subtree for vertex v (possibly
//   empty) in t1 equals t2.
//
// Example
//
// For
...
console.log(isSubtree(tree1, tree2), 'sb true');
...
console.log(isSubtree(tree1, tree2), 'sb false');
